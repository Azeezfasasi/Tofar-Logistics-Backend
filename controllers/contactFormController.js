...
exports.submitContactForm = async (req, res) => {
  try {
            ...
            <table role="presentation" border="0" cellpadding="0" cellspacing="0" width="100%">
              <tr>
                <td style="padding: 20px 30px;">
                  ...
                  <p style="margin-bottom: 15px; font-size: 16px;">Thank you for contacting Tofar Logistics Agency. We have received your quote request and will get back to you as soon as possible.</p>
                  ...
                  <p style="margin-top: 5px; margin-bottom: 0; font-size: 16px; font-weight: bold;">Tofar Logistics Agency Team</p>
                </td>
              </tr>
            </table>
    ...
    `;
    await sendMail(email, 'Quote Request Received - Tofar Logistics Agency', clientEmailContent);
            ...
            <table role="presentation" border="0" cellpadding="0" cellspacing="0" width="100%">
              <tr>
                <td style="padding: 20px 30px;">
                  ...
                  <p style="margin-bottom: 15px; font-size: 16px;">Thank you for your message. Here is a reply from Tofar Logistics Agency:</p>
                  <blockquote style="border-left: 4px solid #ccc; margin: 0; padding-left: 10px; color: #555; font-style: italic;">
                    <p>${replyContent}</p>
                  </blockquote>
