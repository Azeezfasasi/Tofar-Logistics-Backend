...
exports.createAppointment = async (req, res) => {
  try {
    ...
    const userEmailContent = `
      <p>Hi ${name},</p>
      <p>Thank you for booking an appointment with Tofar Logistics Agency.</p>
      <p>Your appointment details are:</p>
      <ul>
        <li><strong>Date:</strong> ${formatDateForEmail(appointmentDate)}</li>
        <li><strong>Time:</strong> ${appointmentTime}</li>
        <li><strong>Status:</strong> Pending (awaiting confirmation from Tofar Logistics Agency staff)</li>
      </ul>
...
exports.deleteAppointment = async (req, res) => {
  try {
    ...
    const emailContent = `
      ...
      <p>Your appointment scheduled for ${formatDateForEmail(deletedAppointment.appointmentDate)} at ${deletedAppointment.appointmentTime} has been deleted by Tofar Logistics Agency.</p>
...
exports.rescheduleAppointment = async (req, res) => {
  try {
    ...
    const userEmailContent = `
      ...
      <p>Your appointment with Tofar Logistics Agency has been rescheduled.</p>
...
exports.cancelAppointment = async (req, res) => {
  try {
    ...
    const userEmailContent = `
      ...
      <p>Your appointment with Tofar Logistics Agency scheduled for ${formatDateForEmail(appointment.appointmentDate)} at ${appointment.appointmentTime} has been cancelled.</p>
