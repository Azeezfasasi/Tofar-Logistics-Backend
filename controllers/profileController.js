...
exports.register = async (req, res) => {
  try {
    ...
    await sendMail(email, 'Welcome to Tofar Logistics Agency', `<p>Hi ${name}, welcome to Tofar Logistics Agency!</p>`);
  ...
  try {
    ...
    await sendMail(userToUpdate.email, 'Your Password Has Been Changed',
      `<p>Hi ${userToUpdate.name},</p>
       <p>Your password for Tofar Logistics Agency account has been changed by an administrator.</p>
